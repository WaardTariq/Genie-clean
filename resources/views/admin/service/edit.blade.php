                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-12 col-sm-12 mt-3">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ $service->name ?? 'Not Found' }}">
                            </div>
                            <div class="col-lg-8 col-md-12 col-sm-12 mt-3">
                                <label for="">Duration :</label>
                                <input type="number" class="form-control" name="duration" value="{{ $service->duration ?? 'Not Found' }}">
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                                ...
                                <input type="number" class="form-control" name="price" value="{{ $service->price ?? 'Not Found' }}">
                            </div>
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-12 mt-3">
                                ...
                                <textarea cols="5" rows="5" class="form-control" name="description">{{ $service->description ?? 'Not Found' }}</textarea>
                            </div>
